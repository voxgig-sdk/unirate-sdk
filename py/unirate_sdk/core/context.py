...
from unirate_sdk.core.control import UnirateControl
...
from unirate_sdk.core.helpers import get_ctx_prop, to_map
...
class UnirateContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, UnirateResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return UnirateError(code, msg, self)
