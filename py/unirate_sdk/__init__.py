...
from unirate_sdk.utility import register

# Load features
from unirate_sdk.feature.base_feature import UnirateBaseFeature
from unirate_sdk.features import _has_feature, _make_feature
...
class UnirateSDK:
    ...
    def get_utility(self):
        return UnirateUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UnirateSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Commodity(self, data=None) -> "CommodityEntity":
        ...
        from unirate_sdk.entity.commodity_entity import CommodityEntity
    ...
    def Currency(self, data=None) -> "CurrencyEntity":
        ...
        from unirate_sdk.entity.currency_entity import CurrencyEntity
    ...
    def HistoricalCurrency(self, data=None) -> "HistoricalCurrencyEntity":
        ...
        from unirate_sdk.entity.historical_currency_entity import HistoricalCurrencyEntity
    ...
    def VatRate(self, data=None) -> "VatRateEntity":
        ...
        from unirate_sdk.entity.vat_rate_entity import VatRateEntity
