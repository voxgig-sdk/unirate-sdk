...
from unirate_sdk.unirate_types import (
    HistoricalCurrency,
...
class HistoricalCurrencyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return HistoricalCurrencyEntity(self._client, opts)
    ...
    def data_get(self) -> HistoricalCurrency:
    ...
    def match_get(self) -> HistoricalCurrency:
    ...
    def load(self, reqmatch=None, ctrl=None) -> HistoricalCurrency:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.HistoricalCurrency().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
