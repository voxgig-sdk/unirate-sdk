...
from unirate_sdk.core.spec import UnirateSpec
from unirate_sdk.core.result import UnirateResult
from unirate_sdk.core.response import UnirateResponse
from unirate_sdk.core.operation import UnirateOperation
from unirate_sdk.core.error import UnirateError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = UnirateSDK.test(None, None)
        ...
        class TestInitFeature(UnirateBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(UnirateBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = UnirateSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = UnirateSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = UnirateSDK.test(None, setup_opts)
