# Unirate SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UnirateSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UnirateSDK(...) and UnirateSDK.test(...) become
#      UnirateSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "unirate_sdk"
_SDK_CLASS = "UnirateSDK"
...
_ENTITIES = {
    "Commodity": "commodity",
    "Currency": "currency",
    "HistoricalCurrency": "historical_currency",
    "VatRate": "vat_rate",
}
