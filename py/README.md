...
The Python SDK for the Unirate API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Commodity()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/unirate-sdk/releases)) or
...
```
py/
├── unirate_sdk.py         -- Main SDK module
