...
const testSeed = `map[string]any{"entity": map[string]any{"commodity": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "currency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "historical_currency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "vat_rate": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
