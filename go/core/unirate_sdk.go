...
func (sdk *UnirateSDK) OptionsMap() map[string]any {
...
func (sdk *UnirateSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *UnirateSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *UnirateSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UnirateSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *UnirateSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *UnirateSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("UnirateSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *UnirateSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UnirateSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("UnirateSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
