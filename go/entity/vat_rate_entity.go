...
func NewVatRateEntity(client *core.UnirateSDK, entopts map[string]any) *VatRateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VatRateEntity) GetName() string { return e.name }
...
func (e *VatRateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VatRateEntity) Deleted() bool {
	return e.deleted
}


func (e *VatRateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVatRateEntity(e.client, opts)
}

func (e *VatRateEntity) Data(args ...any) any {
...
func (e *VatRateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *VatRateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VatRateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *VatRateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *VatRateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VatRateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VatRateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
