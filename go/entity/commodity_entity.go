...
func NewCommodityEntity(client *core.UnirateSDK, entopts map[string]any) *CommodityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CommodityEntity) GetName() string { return e.name }
...
func (e *CommodityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CommodityEntity) Deleted() bool {
	return e.deleted
}


func (e *CommodityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCommodityEntity(e.client, opts)
}

func (e *CommodityEntity) Data(args ...any) any {
...
func (e *CommodityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Commodity; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CommodityEntity) DataTyped(data ...Commodity) Commodity {
	if len(data) > 0 {
		return typedFrom[Commodity](e.Data(asMap(data[0])))
	}
	return typedFrom[Commodity](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Commodity (all fields
// optional at the wire level).
func (e *CommodityEntity) MatchTyped(match ...Commodity) Commodity {
	if len(match) > 0 {
		return typedFrom[Commodity](e.Match(asMap(match[0])))
	}
	return typedFrom[Commodity](e.Match())
}
...
func (e *CommodityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CommodityEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CommodityLoadMatch and returns an Commodity. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CommodityEntity) LoadTyped(reqmatch CommodityLoadMatch, ctrl map[string]any) (Commodity, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Commodity{}, err
	}
	return typedFrom[Commodity](res), nil
}



func (e *CommodityEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CommodityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CommodityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CommodityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CommodityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
