...
class UnirateTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UnirateTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = UnirateTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = UnirateTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
