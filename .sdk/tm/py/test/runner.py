...
class UnirateTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UnirateTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = UnirateTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = UnirateTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
