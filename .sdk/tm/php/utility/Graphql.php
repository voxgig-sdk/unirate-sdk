...
class UnirateGraphql
{
    ...
    // equivalent.
    public static function body(UnirateContext $ctx): mixed
    {
    ...
    public static function errors(UnirateContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
