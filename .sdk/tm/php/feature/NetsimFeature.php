...
class UnirateNetsimFeature extends UnirateBaseFeature
{
    ...
    private function _simulate(UnirateContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UnirateContext $ctx, array $applied): void
    {
        $client = $this->client;
