...
// Unirate SDK clienttrack feature
...
class UnirateClienttrackFeature extends UnirateBaseFeature
{
    ...
    public function PostConstruct(UnirateContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Unirate-SDK';
