...
class UnirateProxyFeature extends UnirateBaseFeature
{
    ...
    public function init(UnirateContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UnirateContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
