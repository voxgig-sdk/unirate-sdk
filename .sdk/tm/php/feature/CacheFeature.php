...
class UnirateCacheFeature extends UnirateBaseFeature
{
    ...
    private function _through(UnirateContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
