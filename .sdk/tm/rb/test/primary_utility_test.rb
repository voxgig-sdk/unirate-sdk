...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = UnirateOmni.make_runner(TEST_JSON_FILE, UnirateSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : UnirateOmni.errify(err)
    end
