...
|---|---|---|
| `ts/` | @voxgig-sdk/unirate-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/unirate-sdk \
      --repository voxgig-sdk/unirate-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/unirate-sdk` shows it, and
`npm trust revoke @voxgig-sdk/unirate-sdk --id=<id>` removes it.
