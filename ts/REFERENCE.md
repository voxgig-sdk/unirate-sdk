# Unirate TypeScript SDK Reference

Complete API reference for the Unirate TypeScript SDK.
...
#### `UnirateSDK.test(testopts?, sdkopts?)`
...
**Returns:** `UnirateSDK` instance in test mode.


### Instance Methods

#### `Commodity(data?: object)`

Create a new `Commodity` entity instance.
...
**Returns:** `CommodityEntity` instance.
...
#### `HistoricalCurrency(data?: object)`

Create a new `HistoricalCurrency` entity instance.
...
**Returns:** `HistoricalCurrencyEntity` instance.

#### `VatRate(data?: object)`

Create a new `VatRate` entity instance.
...
**Returns:** `VatRateEntity` instance.
...
```ts
const result = await client.Commodity().load({ api_key: 'api_key' })
```
...
Return the parent `UnirateSDK` instance.
...
```ts
const result = await client.Currency().load({ api_key: 'api_key' })
```
...
```ts
const result = await client.HistoricalCurrency().load({ api_key: 'api_key' })
```
...
```ts
const result = await client.VatRate().load({ api_key: 'api_key' })
```
