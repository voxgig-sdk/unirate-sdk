...
function envOverride(m) {
    if ('TRUE' === process.env.UNIRATE_TEST_LIVE ||
        'TRUE' === process.env.UNIRATE_TEST_OVERRIDE) {
    ...
    m.UNIRATE_TEST_EXPLAIN = process.env.UNIRATE_TEST_EXPLAIN || m.UNIRATE_TEST_EXPLAIN;
    return m;
}
