...
(0, node_test_1.describe)('CommodityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-commodity', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-commodity', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['UNIRATE_TEST_COMMODITY_ENTID'];
...
//# sourceMappingURL=CommodityDirect.test.js.map