...
(0, node_test_1.describe)('VatRateEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'vat_rate.' + op, live))
                return;
        }
        ...
        let vat_rate_ref01_data = Object.values(setup.data.existing.vat_rate)[0];
        // LOAD
        const vat_rate_ref01_ent = client.VatRate();
        const vat_rate_ref01_match_dt0 = {};
        const vat_rate_ref01_data_dt0 = (await vat_rate_ref01_ent.load(vat_rate_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != vat_rate_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/vat_rate/VatRateTestData.json');
    ...
    let idmap = transform(['vat_rate01', 'vat_rate02', 'vat_rate03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=VatRateEntity.test.js.map