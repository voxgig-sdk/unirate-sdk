...
(0, node_test_1.describe)('VatRateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-vat_rate', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-vat_rate', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['UNIRATE_TEST_VAT_RATE_ENTID'];
...
//# sourceMappingURL=VatRateDirect.test.js.map