...
(0, node_test_1.describe)('HistoricalCurrencyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'historical_currency.' + op, live))
                return;
        }
        ...
        let historical_currency_ref01_data = Object.values(setup.data.existing.historical_currency)[0];
        // LOAD
        const historical_currency_ref01_ent = client.HistoricalCurrency();
        const historical_currency_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(null != historical_currency_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/historical_currency/HistoricalCurrencyTestData.json');
    ...
    let idmap = transform(['historical_currency01', 'historical_currency02', 'historical_currency03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=HistoricalCurrencyEntity.test.js.map