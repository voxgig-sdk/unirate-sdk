...
(0, node_test_1.describe)('HistoricalCurrencyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-historical_currency', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-historical_currency', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.UNIRATE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.UnirateSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['UNIRATE_TEST_HISTORICAL_CURRENCY_ENTID'];
    ...
    const client = new __1.UnirateSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=HistoricalCurrencyDirect.test.js.map