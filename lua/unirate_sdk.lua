...
UnirateSDK._make_feature = _make_feature


function UnirateSDK.new(options)
  local self = setmetatable({}, UnirateSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function UnirateSDK:options_map()
...
function UnirateSDK:get_utility()
  return Utility.copy(self._utility)
end


function UnirateSDK:get_root_ctx()
  return self._rootctx
end


function UnirateSDK:prepare(fetchargs)
...
function UnirateSDK:direct(fetchargs)
...
-- by passing it.
function UnirateSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function UnirateSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "UnirateSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function UnirateSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = UnirateSDK.new(sdkopts)
  sdk.mode = "test"
