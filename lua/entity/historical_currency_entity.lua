...
local HistoricalCurrencyEntity = {}
HistoricalCurrencyEntity.__index = HistoricalCurrencyEntity


function HistoricalCurrencyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, HistoricalCurrencyEntity)
  self._name = "historical_currency"
  self._client = client
...
function HistoricalCurrencyEntity:get_name()
  return self._name
end


function HistoricalCurrencyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return HistoricalCurrencyEntity.new(self._client, opts)
end
...
function HistoricalCurrencyEntity:mark_deleted()
  self._deleted = true
end


function HistoricalCurrencyEntity:deleted()
  return true == self._deleted
end


function HistoricalCurrencyEntity:data_set(args)
  if args ~= nil then
...
function HistoricalCurrencyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function HistoricalCurrencyEntity:match_set(args)
  if args ~= nil then
...
function HistoricalCurrencyEntity:match_get()
...
function HistoricalCurrencyEntity:stream(action, args, callopts)
...
---@param reqmatch HistoricalCurrencyLoadMatch
---@param ctrl? table
---@return HistoricalCurrency
---@return string? err
function HistoricalCurrencyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function HistoricalCurrencyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return HistoricalCurrencyEntity
