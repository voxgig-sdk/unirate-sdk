-- Unirate SDK Commodity entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CommodityEntity = {}
CommodityEntity.__index = CommodityEntity


function CommodityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CommodityEntity)
...
function CommodityEntity:get_name()
  return self._name
end


function CommodityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CommodityEntity.new(self._client, opts)
end
...
function CommodityEntity:mark_deleted()
  self._deleted = true
end


function CommodityEntity:deleted()
  return true == self._deleted
end


function CommodityEntity:data_set(args)
  if args ~= nil then
...
function CommodityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CommodityEntity:match_set(args)
  if args ~= nil then
...
function CommodityEntity:match_get()
...
function CommodityEntity:stream(action, args, callopts)
...
---@param reqmatch CommodityLoadMatch
---@param ctrl? table
---@return Commodity
---@return string? err
function CommodityEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CommodityEntity:_run_op(ctx, post_done)
  local utility = self._utility
