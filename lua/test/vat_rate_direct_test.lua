...
describe("VatRateDirect", function()
  it("should direct-load-vat_rate", function()
    local setup = vat_rate_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-vat_rate", setup.live and "live" or "unit")
...
function vat_rate_direct_setup(mockres)
