...
describe("CommodityDirect", function()
  it("should direct-load-commodity", function()
    local setup = commodity_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-commodity", setup.live and "live" or "unit")
...
function commodity_direct_setup(mockres)
