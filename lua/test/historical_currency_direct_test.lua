-- HistoricalCurrency direct test
...
describe("HistoricalCurrencyDirect", function()
  it("should direct-load-historical_currency", function()
    local setup = historical_currency_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-historical_currency", setup.live and "live" or "unit")
...
function historical_currency_direct_setup(mockres)
