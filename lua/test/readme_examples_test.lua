...
-- data to return.
local TEST_SEED = '{ entity = { ["commodity"] = { ["test01"] = { id = "test01" } }, ["currency"] = { ["test01"] = { id = "test01" } }, ["historical_currency"] = { ["test01"] = { id = "test01" } }, ["vat_rate"] = { ["test01"] = { id = "test01" } } } }'
