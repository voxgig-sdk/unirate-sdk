...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/unirate` | `npm install @voxgig-sdk/unirate` |
| Python | `voxgig-sdk-unirate` | `pip install voxgig-sdk-unirate` |
| PHP | `voxgig-sdk/unirate` | `composer require voxgig-sdk/unirate` |
| Golang | `github.com/voxgig-sdk/unirate-sdk/go` | `go get github.com/voxgig-sdk/unirate-sdk/go` |
| Ruby | `voxgig-sdk-unirate` | `gem install voxgig-sdk-unirate` |
| Lua | `voxgig-sdk-unirate` | `luarocks install voxgig-sdk-unirate` |
