...
func registerSDKWords(r *eng.Registry, client *sdk.UnirateSDK) {
...
func runOp(client *sdk.UnirateSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
