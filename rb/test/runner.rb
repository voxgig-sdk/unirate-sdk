...
module UnirateTestRunner
  ...
  def self.env_override(m)
    live = getenv("UNIRATE_TEST_LIVE")
    override = getenv("UNIRATE_TEST_OVERRIDE")
    ...
    explain = getenv("UNIRATE_TEST_EXPLAIN")
    m["UNIRATE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = UnirateTestRunner
Helpers = UnirateHelpers
Vs = VoxgigStruct
