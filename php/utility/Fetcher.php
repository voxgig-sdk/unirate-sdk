...
// Unirate SDK utility: fetcher

class UnirateFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UnirateSDK/1.0)';
    ...
    public static function call(UnirateContext $ctx, string $fullurl, array $fetchdef): array
    {
