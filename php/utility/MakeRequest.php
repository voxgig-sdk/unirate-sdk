...
// Unirate SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class UnirateMakeRequest
{
    public static function call(UnirateContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new UnirateResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new UnirateResponse($fetched);
        } else {
