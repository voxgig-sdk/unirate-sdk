...
class VatRateDirectTest extends TestCase
{
    public function test_direct_load_vat_rate(): void
    {
        $setup = vat_rate_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-vat_rate", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
