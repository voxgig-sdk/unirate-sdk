...
// Unirate SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UnirateSDK::test)
...
{
    private const SDK_CLASS = 'UnirateSDK';
    ...
    private const SDK_BASE = 'unirate_sdk';
