...
// Unirate SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = UnirateOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(UnirateOmni::structfix($now, Struct::undef()))
                        !== json_encode(UnirateOmni::structfix($val, Struct::undef()))) {
