...
class UnirateTestRunner
{
    ...
    {
        $live = self::getenv('UNIRATE_TEST_LIVE');
        $override = self::getenv('UNIRATE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('UNIRATE_TEST_EXPLAIN');
...
class_alias('UnirateTestRunner', 'Runner');
class_alias('UnirateHelpers', 'Helpers');
