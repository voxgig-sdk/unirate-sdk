...
The PHP SDK for the Unirate API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Commodity(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Unirate(null)->load(
    ["id" => "test01"], null
);
