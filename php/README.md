...
The PHP SDK for the Unirate API — an entity-oriented client using PHP conventions.
...
```
php/
├── unirate_sdk.php          -- Main SDK class
...
The main class (`unirate_sdk.php`) exports the SDK class
