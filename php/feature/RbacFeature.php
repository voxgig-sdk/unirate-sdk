...
class UnirateRbacFeature extends UnirateBaseFeature
{
    ...
    private function _required(UnirateContext $ctx): ?string
    {
    ...
    private function _reject(UnirateContext $ctx, string $required): void
    {
    ...
    private function _track(UnirateContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
