...
class UnirateStreamingFeature extends UnirateBaseFeature
{
    ...
    private function _iterate(UnirateResult $result): \Generator
    {
    ...
    private function _streamable(UnirateContext $ctx): bool
    {
