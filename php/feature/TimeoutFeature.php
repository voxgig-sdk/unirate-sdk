...
class UnirateTimeoutFeature extends UnirateBaseFeature
{
    ...
    private function _with_timeout(UnirateContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UnirateContext $_ctx, float $ms): void
    {
        $client = $this->client;
