...
// Unirate SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class UnirateTestFeature extends UnirateBaseFeature
{
    ...
    public function init(UnirateContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (UnirateContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (UnirateContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(UnirateContext $ctx, $op, $args): array
    {
