...
class UnirateRatelimitFeature extends UnirateBaseFeature
{
    ...
    private function _acquire(UnirateContext $ctx): void
    {
    ...
    private function _track(UnirateContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
