...
class VatRateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new VatRateEntity($this->_client, $opts);
    }

    /**
     * @param VatRate|array $args VatRate data (assoc-array) to store.
     */
    ...
    /**
     * @return VatRate|array The current VatRate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of VatRate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of VatRate fields).
     */
    ...
    /**
     * Load a single VatRate.
     *
     * @param VatRateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed VatRateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return VatRate|array The loaded VatRate as an assoc-array at the
